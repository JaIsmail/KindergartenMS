...
// Seed default permissions
    ...
    public async Task<IActionResult> Seed()
    {
        ...
        var permissions = new List<Permission>
        {
            ...
            new() { Name="Trips.Add",             Category="Trips",        DisplayNameAr="إضافة رحلة",                DisplayNameEn="Add Trip",                DescriptionAr="إنشاء رحلة جديدة",                   DescriptionEn="Create a new trip" },
            new() { Name="Trips.Start",           Category="Trips",        DisplayNameAr="بدء الرحلة",                DisplayNameEn="Start Trip",              DescriptionAr="بدء رحلة (سائق)",                    DescriptionEn="Start a trip (driver)" },
            new() { Name="Trips.End",             Category="Trips",        DisplayNameAr="إنهاء الرحلة",              DisplayNameEn="End Trip",                DescriptionAr="إنهاء رحلة (سائق)",                  DescriptionEn="End a trip (driver)" },
            new() { Name="Trips.UpdateChildStatus", Category="Trips",      DisplayNameAr="تحديث حالة الطفل",          DisplayNameEn="Update Child Status",     DescriptionAr="تحديث حالة استلام/تسليم الطفل",      DescriptionEn="Update a child's pickup/dropoff status" },
            new() { Name="Trips.Maintain",        Category="Trips",        DisplayNameAr="صيانة الرحلات",             DisplayNameEn="Maintain Trips",          DescriptionAr="إصلاح حالات الرحلات العالقة",        DescriptionEn="Fix stuck/pending trip statuses" },
            new() { Name="Trips.Delete",          Category="Trips",        DisplayNameAr="حذف الرحلة",                DisplayNameEn="Delete Trip",             DescriptionAr="حذف رحلة",                            DescriptionEn="Delete a trip" },
            ...
            new() { Name="Lists.Add",             Category="Lists",        DisplayNameAr="إضافة عنصر للقائمة",        DisplayNameEn="Add List Item",           DescriptionAr="إضافة عنصر جديد للقائمة",            DescriptionEn="Add a new list item" },
            new() { Name="Lists.Edit",            Category="Lists",        DisplayNameAr="تعديل عنصر القائمة",        DisplayNameEn="Edit List Item",          DescriptionAr="تعديل عنصر موجود في القائمة",        DescriptionEn="Edit an existing list item" },
            new() { Name="Lists.Delete",          Category="Lists",        DisplayNameAr="حذف عنصر القائمة",          DisplayNameEn="Delete List Item",        DescriptionAr="حذف عنصر من القائمة",                DescriptionEn="Delete a list item" },
            // ── Permissions ───────────────────────────────────────
